...
#     """Create tbl_Feedback table if it doesn't exist"""
#     try:
#         with connection.cursor() as cursor:
#             cursor.execute("""
#             IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'tbl_Feedback')
#             BEGIN
...
#         with connection.cursor() as cursor:
#             select_query = f"""
#             SELECT ID, Meeting_ID, User_ID, Rating, Comments, Feedback_Type, Submitted_At
#             FROM {TBL_FEEDBACK}
#             """
...
#             feedback_list = [
#                 dict(zip([
#                     'ID', 'Meeting_ID', 'User_ID', 'Rating', 'Comments', 'Feedback_Type', 'Submitted_At'
#                 ], row))
#                 for row in rows
#             ]
#     except (ProgrammingError, OperationalError) as e:
...
#     return JsonResponse(feedback_list, safe=False, status=SUCCESS_STATUS)
...
#             'ID', 'Meeting_ID', 'User_ID', 'Rating', 'Comments', 'Feedback_Type', 'Submitted_At'
#         ], row))
#         return JsonResponse(feedback, status=SUCCESS_STATUS)
