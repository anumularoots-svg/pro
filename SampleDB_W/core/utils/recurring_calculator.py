...
#     """
#     Calculate the next occurrence of a recurring meeting
#     """
...
#         logging.error(f"Failed to parse start_time: {e}")
#         return None
    
#     # If not recurring, return original time if it's in the future
#     if not meeting_data.get('is_recurring'):
#         if start_time >= current_time:
#             return {
#                 'next_start_time': start_time.isoformat(),
#                 'next_end_time': meeting_data.get('end_time'),
#                 'is_today': start_time.date() == current_time.date(),
#                 'is_completed_today': start_time < current_time and start_time.date() == current_time.date()
#             }
#         return None
