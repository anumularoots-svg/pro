// src/pages/MeetingPage.jsx - Enhanced Professional UI Version
...
const MeetingPage = () => {
  ...
  // Enhanced leave meeting handler with LiveKit cleanup
  const handleLeaveMeeting = useCallback(async () => {
    try {
      console.log('👋 MeetingPage: Leaving meeting with LiveKit cleanup...');
