// Enhanced RecordingsList.jsx with trash functionality
...
const RecordingsList = ({ 
  ...
  }, [transformedRecordings, searchTerm, filterType, sortBy]);
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth sx={{ backgroundColor: 'white', borderRadius: 1 }}>
                ...
                >
                  ...
                  <MenuItem value="instant">Instant Meetings</MenuItem>
                  <MenuItem value="scheduled">Scheduled Meetings</MenuItem>
                  <MenuItem value="calendar">Calendar Meetings</MenuItem>
                </Select>
              </FormControl>
            </Grid>
