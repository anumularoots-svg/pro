...
const WaitingRoom = ({ 
  ...
  const FACE_AUTH_API_URL = 'https://192.168.48.201:8119/api/user/verify-face';
  ...
  const toggleVideo = useCallback(() => {
    ...
    setVideoEnabled(prevState => {
      ...
      // Force video element to refresh when enabling
  ...
  const refreshDevices = async () => {
    ...
    // Reset states
    setMediaInitializationAttempts(0);
      ...
      <ContentWrapper>
        ...
        <LeftSection>
          ...
          <VideoContainer>
            ...
            {videoEnabled && stream && !isInitializing ? (
              <VideoElement
                ref={videoRef}
                autoPlay
                muted
          ...
          <StatusCard>
            <CardContent>
              ...
              <VerifyButton
                ...
                startIcon={isFaceVerifying ? <CircularProgress size={16} /> : <Refresh />}
                sx={{ mt: 1.5 }}
              >
